...
import './Landing.css';
import land from '../../asset/brand/bike1.png';
        ...
        <div className="landing__container">
            <div className="landing__header__container">
                <div className="landing__header">
                    ...
                    <h1 className="landing__header__main">Complete Solution for Two Wheeler</h1>
                    <Link to="/shop">
            ...
            <div className="landing__image__container">
                <img className="landing__image" src={land} alt="Bike"/>
            </div>
        </div>
     );
}
